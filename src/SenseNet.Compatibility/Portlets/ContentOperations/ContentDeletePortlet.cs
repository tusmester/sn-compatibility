...
{
    public abstract class ContentDeletePortlet : ContentCollectionPortlet
    {
        private const string ContentDeletePortletClass = "ContentDeletePortlet";
        ...
        {
            this.Name = "$ContentDeletePortlet:PortletDisplayName";
            this.Description = "$ContentDeletePortlet:PortletDescription";
        ...
        [WebBrowsable(true)]
        [Personalizable(true)]
        [LocalizedWebDisplayName(ContentDeletePortletClass, "Prop_UserInterfacePath_DisplayName")]
        [LocalizedWebDescription(ContentDeletePortletClass, "Prop_UserInterfacePath_Description")]
        ...
        [LocalizedWebDisplayName(ContentDeletePortletClass, "Prop_ViewPathBatchDelete_DisplayName")]
        [LocalizedWebDescription(ContentDeletePortletClass, "Prop_ViewPathBatchDelete_Description")]
            ...
            switch (e.CommandName.ToLower())
            {
                case "yes":
                    try
                    {
                        ...
                        {
                            var p = Page as PageBase;
                            if (p != null) p.Response.Redirect(ContextNode.ParentPath, false);
                        }
                        else
                        {
                            CallDone(false);
        ...
        private static void SetLabel(Control control, string labelId, string name, string path)
        {
            ...
            catch (ArgumentNullException argumentNullException)
            {
                ...
                SnLog.WriteException(argumentNullException);
            }
            catch (FormatException formatException)
            {
                ...
                label.ForeColor = System.Drawing.Color.Red;
                label.Text = "You have a wrong formatted string in " + label.ID;
                SnLog.WriteException(formatException);
            }
        }
