...
namespace SenseNet.Portal.Portlets
{
    public class ContentLinkerPortlet : ContentCollectionPortlet
    {
        ...
        {
            this.Name = "$ContentLinkerPortlet:PortletDisplayName";
            this.Description = "$ContentLinkerPortlet:PortletDescription";
        ...
        protected override void CreateChildControls()
        {
            ...
            try
            {
                ...
                var viewControl = Page.LoadControl(SkinManager.Resolve(ViewPath)) as UserControl;
                if (viewControl == null)
                    return;
