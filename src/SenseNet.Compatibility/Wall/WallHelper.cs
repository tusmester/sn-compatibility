...
namespace SenseNet.Portal.Wall
{
    public class WallHelper
    {
        ...
        {
            return GetMarkupString("$skin/renderers/Wall/Post.html");
        }
        public static string GetSmallPostMarkupStr()
        {
            return GetMarkupString("$skin/renderers/Wall/SmallPost.html");
        }
        public static string GetContentWallMarkupStr()
        {
            return GetMarkupString("$skin/renderers/Wall/ContentWall.html");
        }
        public static string GetCommentMarkupStr()
        {
            return GetMarkupString("$skin/renderers/Wall/Comment.html");
        }
        public static string GetCommentSectionMarkupStr()
        {
            var markupStr = GetMarkupString("$skin/renderers/Wall/CommentSection.html");
        ...
        {
            var markupStr = GetMarkupString("$skin/renderers/Wall/LikeListItem.html");
            if (markupStr == null)
                return null;
        ...
        public static bool HasWallPermission(string workspacePath, Node workspace)
        {
            ...
            return checkedFolder.Security.HasPermission(SenseNet.ContentRepository.Storage.Security.PermissionType.AddNew) && SenseNet.Portal.Wall.WallApi.HasPermission();
        }
        ...
        {
            return commentNode.Security.HasPermission(SenseNet.ContentRepository.Storage.Security.PermissionType.AddNew) && SenseNet.Portal.Wall.WallApi.HasPermission();
        }
        ...
        public static string GetXmlDecodedString(string source)
        {
            return string.IsNullOrEmpty(source) ? source : source.Replace("&lt;", "<").Replace("&gt;", ">");
        }
    }
}
