...
namespace SenseNet.Portal.UI.Controls
{
    ...
    public class RateControl : Panel, IScriptControl, INamingContainer
    {
        ...
        private bool _allowReRating = false;
        ...
        {
            get { return _enableCookies; }
            set { _enableCookies = value; }
        }

        [PersistenceMode(PersistenceMode.Attribute)]
        [DefaultValue(false)]
        public bool AllowReRating
        {
            get { return _allowReRating; }
            set { _allowReRating = value; }
        }
        ...
        public IEnumerable<ScriptDescriptor> GetScriptDescriptors()
        {
            ...
            scriptDescriptor.AddProperty("EnableCookies", _enableCookies);
            scriptDescriptor.AddProperty("AllowReRating", _allowReRating);
