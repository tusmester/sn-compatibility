...
namespace SenseNet.Portal.Portlets.Controls
{
    public class AuditLogControl : UserControl
    {
        ...
        {
            startDate.Text = DateTime.UtcNow.AddDays(-1).ToString();
            base.OnInit(e);
            auditlogDataSource.ConnectionString = ConnectionStrings.ConnectionString;
            eventTypeDataSource.ConnectionString = ConnectionStrings.ConnectionString;
