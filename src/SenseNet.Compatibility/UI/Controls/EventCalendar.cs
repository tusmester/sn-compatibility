...
namespace SenseNet.Portal.Portlets.Controls
{
    public class EventCalendar : UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            MyCalendar.TodaysDate = DateTime.UtcNow;
        }
        ...
        private static bool IsUserAlreadySubscribed(Node item, out string registeredItem)
        {
            ...
            if (regForm != null)
            {
                var result = ContentQuery.Query("+Type:eventregistrationformitem +ParentId:@0 +CreatedById:@1 .AUTOFILTERS:OFF .LIFESPAN:OFF", null, regForm.Id, User.Current.Id);
